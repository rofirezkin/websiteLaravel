        ...
        <div id="top" class="fixed">
            ...
            <nav class="navbar navbar-static-top">
                <div class="container-fluid m-0">
                    ...
                    <h4 class="text-white"><img src="{{url('backend/img/logow.png')}}" class="admin_img" alt="logo">
                    ...
                    <div class="navbar-toggleable-sm m-lg-auto d-none d-md-block d-lg-flex top_menu" id="nav-content">
                    ...
                    <div class="topnav dropdown-menu-right ml-auto">
                        ...
                        <div class="btn-group ">
                            <div class="notifications no-bg">
                                <a class="btn btn-default btn-sm messages d-none d-md-block" data-toggle="dropdown"> <i
                        ...
                        <div class="btn-group">
                            <div class="user-settings no-bg">
                                ...
                                <img src="{{url('backend/img/admin.jpg')}}" class="admin_img2 rounded-circle avatar-img" alt="avatar">
                                    <strong>Micheal</strong>
                                    <span class="fa fa-sort-down white_bg"></span>
                                </button>
                                <div class="dropdown-menu admire_admin">
                                    <div class="popover-header">michael</div>
                                <a class="dropdown-item" href="{{url('profile')}}"><i class="fa fa-cogs"></i>
                                        Pengaturan Akun</a>
                                    ...
                                    <a class="dropdown-item" href="{{url('toko')}}"><i class="fas fa-industry"></i>
                                        Toko Saya</a>
                                    <a class="dropdown-item" href="{{url('/')}}"><i class="	fa fa-sign-out"
                                            ...
                                            <div class="col-lg-10">
                                                <!-- <form class="form-horizontal"> -->
                                                    <!-- <fieldset> -->
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="input-group input-group-prepend">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="signup_email" placeholder="E-mail">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="input-group input-group-prepend">
                                                                    ...
                                                                    <input type="password" id="signup_confirm"
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="input-group float">
                                                                    <textarea class="form-control" rows="4" placeholder="Alamat Lengkap Anda"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-11">
                                                               <a href="profil.html"> <button
                                                                    class="btn btn-warning layout_btn_prevent">Cancel</button></a>
                                                            <a href="profil.html">   <button class="btn btn-primary layout_btn_prevent">Simpan</button></a> 
