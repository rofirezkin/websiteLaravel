...
<div id="content" class="bg-container fixed_header_menu_conainer fixed_header_menu_page">
    <header class="head">
        <div class="main-bar" style="margin-top: 50px">
            <div class="row">
                <div class="col-lg-5">
                    <h4 class="nav_top_align"><i class="fa fa-th"></i> Toko Saya</h4>
                </div>
                <div class="col-lg-7">
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body card_block_top_align ">
                            <h4>Ayo Lengkapi Toko Anda</h4>
                            <!-- for upload produk -->
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class=" bg-secondary m-t-35">
                                        <div class="card-header bg-secondary text-white">Upload Produk Anda
                                        </div>
                                        <div class="card-body">
                                            <p class="card-text text-white"> Posting Produk Anda dan
                                                Dapatkan Untung.
                                                Ayo Coba
                                                Sekarang.</p>
                                            <!-- Links -->
                                            <div class="text-right">
                                                <a href="upload.html" class="card-link text-success">Upload
                                                    Produk</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class=" bg-secondary m-t-35">
                                        <div class="card-header bg-secondary text-white">Atur Ulang Produk
                                            Yang Sedang Dijual</div>
                                        <div class="card-body">
                                            <p class="card-text text-white"> Atur Ulang Secara Detail Dari
                                                Produk Anda Jika
                                                Ingin Mengembangkan Deskripsi Produk</p>
                                            <!-- Links -->
                                            <div class="text-right">
                                                <a href="upload.html" class="card-link text-success">Upload
                                                    Produk</a>
                            ...
                            <!--banner  -->
                            <div class="mt-5">
                                <img src="{{url('backend/img/swiper_image4.jpg')}}" width="100%" alt="">

                            </div>
                            <!-- end banner -->
                            <!-- bars statistic rate your market -->
                            <div class="row sales_section mt-5">
                                <div class="col-xl col-sm-6 col-12">
                                    <div class="card p-d-15">
                                        ...
                                        <div>
                                            <h5 class="sales_orders text-right m-t-5">Pesanan Minggu Ini
                                            </h5>
                                ...
                                <div class="col-xl col-sm-6 col-12 media_max_573">
                                    <div class="card p-d-15">
                                        ...
                                        <div>
                                            <h5 class="sales_orders text-right m-t-5">Pelanggan Minggu ini
                                            </h5>
                                            <h1 class="sales_number m-t-15 text-right">$<span
                                                    id="revenue_countup">600</span>
                                            </h1>
                                            <p class="sales_text">Total Pelanggan: 8,250
                                    ...
                                    <div class="card p-d-15">
                                        ...
                                        <div>
                                            ...
                                            <h1 class="sales_number m-t-15 text-right"
                                                id="products_countup"> <i class="fa fa-star"
                                                    style="color: yellow;"></i>
                                                <i class="fa fa-star" style="color: yellow;"></i> <i
                                                    class="fa fa-star" style="color: yellow;"></i>
                                                <i class="fa fa-star" style="color: yellow;"></i><i
                                                    class="fa fa-star" style="color: yellow;"></i></h1>
                                            <p class="sales_text">Total User: 12,100
                                                <span class="pull-right"><i
                                                        class="fa fa-caret-up text-primary font_18 m-r-5"></i>10%</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- modals for searching small screen -->
